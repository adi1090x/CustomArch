...
+ **Important -** I've tested it on two laptops, with intel pentium & i3 CPUs. Obviously ISO have intel-video drivers, if you have `nvidia` or something, edit ***packages.x86_64*** and replace the drivers section with your GPU drivers packages, or WM/DE might freeze on startup.
